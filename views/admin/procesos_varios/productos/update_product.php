...
*/
    ...
    if($imgSize == 0){
            ...
            $tabla = "vehiculo";
            $valores = "descripcion='$descripcion',precio_compra='$precio_c',precio_venta='$precio_v',cilindraje=$cilindraje, modelo='$modelo'";
            ...
            if($insert_product){
                ...
                echo '<script>
                    $(document).ready(function(event){
                        alertify.success("vehiculo  no Actualizado...");
                        $("#contenido-procesos").load("procesos_varios/productos/principal_productos.php");
                    })
                </script>';
            }
