...
<body onload="print()">
    ...
    $query = "SELECT COUNT(detalle_venta.id_producto) as cantidad,clientes.nombres as nombres,clientes.apellidos as apellidos,sucursal.nombre_empresa as sucursal,ventas.fecha_venta,ventas.total_pago,ventas.descuento,vehiculo.descripcion as descripcion,vehiculo.modelo as modelo,  detalle_venta.precio_unitario,ventas.id_venta as id_venta FROM detalle_venta INNER JOIN ventas ON detalle_venta.id_venta=ventas.id_venta INNER JOIN sucursal ON detalle_venta.id_sucursal=sucursal.id_empresa INNER JOIN vehiculo ON detalle_venta.id_producto=vehiculo.id_producto INNER JOIN clientes ON detalle_venta.id_venta=ventas.id_venta WHERE ventas.id_venta=$id_venta AND clientes.id_cliente=$dui_client GROUP BY detalle_venta.id_producto";
    ...
    <div>
        <h1>Factura de compra cliente</h1>
        <table>
            <thead>
                <tr>
                <th>Fecha</th>
    ...
    <br>
    <div>
        <h1>Factural de compra Concecionario</h1>
        <table>
            <thead>
                 <tr>
